...
const ALL_TOOLS = [
  ...
  { name: "⏳ D-Day & 군 전역일", path: "디데이 및 전역일 계산기/index.html", cat: "life", related: ["장병내일준비적금 및 군인 월급 계산기","퇴사 및 백수 생존일수 계산기","만 나이 계산기"] },
  ...
  // [5. 🎉 바이럴 & 꿀잼 SNS (5종)]
  { name: "💬 카톡 & 인스타 DM 호감도", path: "카카오톡 대화 호감도 분석기/index.html", cat: "viral", related: ["위드마크 음주 알코올 분해시간 계산기","차수별 더치페이 복합 정산기","퇴사 및 백수 생존일수 계산기"] },
  { name: "🍺 위드마크 음주 분해시간", path: "위드마크 음주 알코올 분해시간 계산기/index.html", cat: "viral", related: ["카카오톡 대화 호감도 분석기","차수별 더치페이 복합 정산기","퇴사 및 백수 생존일수 계산기"] },
  { name: "🏖️ 통장 잔고 백수 버티기", path: "퇴사 및 백수 생존일수 계산기/index.html", cat: "viral", related: ["카카오톡 대화 호감도 분석기","실업급여 계산기","차수별 더치페이 복합 정산기"] },
  { name: "🍻 차수별 복합 n빵 정산기", path: "차수별 더치페이 복합 정산기/index.html", cat: "viral", related: ["위드마크 음주 알코올 분해시간 계산기","카카오톡 대화 호감도 분석기","로또 번호 생성기"] },
